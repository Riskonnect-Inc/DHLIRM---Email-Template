...
;(function($) {
	...
	ScatterChart.prototype = {
		...
		setTooltip: function(chartTooltipConfig) {
			...
			ClaimComparisonChartController.getFieldSettings(chartTooltipConfig.dataHandler.objectName, chartTooltipConfig.fieldSetName, gotTooltipFieldsHandler.bind(self));
		},
			...
			if (focusRecordID) {
				var recordResultHandler = function(recordResult, event) {
					...
					if (event.status) {
						...
						self.rangeHandler.getFieldSettings.call(self.rangeHandler, self.refreshChartView.bind(self));
	...
	FieldRangeHandler.prototype = {
		getFieldSettings: function(callback) {
			...
			if (self.enabledFieldsFieldSetName && self.enabledFieldsFieldSetName != "") {
				ClaimComparisonChartController.getFieldSettings(self.objectName, self.enabledFieldsFieldSetName, resultHandler);
			} else {
